...
import Reto2_Web.repositorio.cosmeticsRepositorio;
...
public class cosmeticsService {
     @Autowired
    private cosmeticsRepositorio clotheRepository;
   ...
   public Optional<cosmetics> getClothe(String reference) {
    ...
    public cosmetics update(cosmetics accesory) {
        ...
        if (accesory.getReference() != null) {
            Optional<cosmetics> accesoryDb = clotheRepository.getClothe(accesory.getReference());
